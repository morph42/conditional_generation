...
class GaussianDiffusion:
    ...
    def __init__(self, T, schedule, implicit=False, gamma=0.5, total_steps=1000):
        # Diffusion steps
        self.T = T
